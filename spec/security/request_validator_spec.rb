...
describe Reach::Security::RequestValidator do
  describe 'configuration' do
    ...
    it 'should set the auth token from a configuration block' do
      ...
      validator = Reach::Security::RequestValidator.new
    ...
    it 'should overwrite the auth token if passed to initializer' do
      ...
      validator = Reach::Security::RequestValidator.new 'otherToken'
    ...
    it 'should throw an argument error if the auth token isn\'t set' do
      expect { Reach::Security::RequestValidator.new }.to raise_error(ArgumentError)
    end
  end
  ...
  describe 'validations' do
    ...
    let(:validator) { Reach::Security::RequestValidator.new token }
    ...
    it 'should validate an authentic Reach request' do
